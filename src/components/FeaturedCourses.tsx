...
function FeaturedCourses() {
  ...
  return (
    <div className='py-12 md:h-[55rem] bg-gray-900'>
      <div>
      ...
      <div className='mt-10'>
        <div className="grid grid-cols-1 sd:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
            ...
            <div key={course.id} className="flex justify-center">
              <BackgroundGradient className='flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm'>
                <div className='p-4 sm:p-6 flex flex-col item-center text-center flex-grow'>
                  ...
                  dark:text-neutral-400 flex-grow'>{course.description}</p>
